...
// special null character that can be set to
// a cell to prevent term box from updating
// that cell at all when tb_present() is called
#define TB_NULL_CHAR UINT32_MAX
